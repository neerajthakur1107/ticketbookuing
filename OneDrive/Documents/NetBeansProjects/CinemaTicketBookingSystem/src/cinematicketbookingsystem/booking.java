...
public class booking extends JFrame implements ActionListener
{
	...
	public booking()
	{
		...
		ImageIcon imgtitle = new ImageIcon("C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\CinemaTicketBookingSystem\\img\\title1.gif");
		...
		ImageIcon lbimg = new ImageIcon("C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\CinemaTicketBookingSystem\\img\\mfghblogo.gif");
		lblbl = new JLabel (lbimg);
		ImageIcon mbimg = new ImageIcon("C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\CinemaTicketBookingSystem\\img\\mblogo1.gif");
		mblbl = new JLabel (mbimg);
		ImageIcon rbimg = new ImageIcon("C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\CinemaTicketBookingSystem\\img\\rblogo.gif");
	...
	public void actionPerformed(ActionEvent ev)
	{
		...
		if (ev.getSource() == submitbut)
		{
			...
			if (selectseat == 15)
				...
				if (selectedtime == "09:00") //If they are trying to book a ticket a 9 o'clock
				{
				timechoice = 1;
				repaint();
...
class Ticket
{
	...
	public Ticket (String type, int seatnumber, String block, String time)
	{
		...
		if (blockticket == "Left Block")
		{
			...
			if (type == "VIP")
			{
				price = 500; //Setting vip price
			}
			if (type == "GOLD")
			{
				price = 300; //Setting gold price
			}
			if (type == "SILVER")
			{
				price = 200;  //Setting silver price
			}
		}
		...
		if (blockticket == "Middle Block")
		{
			...
			if (type == "VIP")
			{
				price = 1000; //Setting vip price
			}
			if (type == "GOLD")
			{
				price = 500; //Setting gold price
			}
			if (type == "SILVER")
			{
				price = 300;  //Setting silver price
			}
		}
