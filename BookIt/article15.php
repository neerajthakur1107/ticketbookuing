...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://velivada.com/wp-content/uploads/2020/09/article-15-review.jpg">
    </div>
    <div class = "info">
      <h1>ARTICLE 15</h1>
      <p>Crime/Action | UA | 2h 20m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
...
parent.location='https://www.youtube.com/watch?v=HKOJY0cU63E'" value='VIEW TRAILER'>
        </td>
        </tr>
     ...
     <div class ="about">
       <h2>About</h2>
       <p>
        In the rural heartlands of India, an upright police officer sets out on a crusade against violent caste-based crimes and discrimination. Inspired by true events and directed by Anubhav Sinha, Article 15 stars Ayushmann Khurrana and Isha Talwar in the lead roles.
       </p>
       <h2>Disclaimer</h2>
       <p>
         <ul>
