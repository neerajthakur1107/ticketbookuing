...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    <div class = "image">
      ...
      <img src="https://static.toiimg.com/photo/51826229.cms">
    </div>
    <div class = "info">
      <h1>PIKU</h1>
      <p>DRAMA/BOLLYWOOD | UA | 2h 05m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=oeiKUlUUNQ8'" value='VIEW TRAILER'>
        </td>
        </tr>
