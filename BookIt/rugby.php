...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://www.lboro.ac.uk/media/media/sport/images/sports/rugby-union/landing-parallax.jpg">
    </div>
    <div class = "info">
      <h1>RUGBY</h1>
      <p>FAMILY/SPORTS</p>
    ...
    <div class= "trailer">
      ...
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=DfZIv2FKWj4'" value='VIEW CLIP'>
        </td>
        </tr>
