...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://i.ytimg.com/vi/prwUFBsDRLk/maxresdefault.jpg">
    </div>
    <div class = "info">
      <h1>THE SKY IS PINK</h1>
      <p>Drama/Romance | UA | 2h 24m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="
parent.location='https://www.youtube.com/watch?v=prwUFBsDRLk'" value='VIEW TRAILER'>
        </td>
        </tr>
    ...
    ?>>BOOK NOW</button>
     ...
     <div class ="about">
       <h2>About</h2>
       <p>
        An incredible true love story of a couple spanning 25 years, told through the lens of their teenage sassy, sardonic, spunky and also dead daughter. A fact she nonchalantly mentions at the outset - "Get over it. It`s quite cool actually. You`ll see when you get here (which you do know you will right?!)"
       </p>
       <h2>Disclaimer</h2>
       <p>
         <ul>
