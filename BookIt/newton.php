...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://i.ytimg.com/vi/F5ZMNflFZ-A/maxresdefault.jpg">
    </div>
    <div class = "info">
      <h1>NEWTON</h1>
      <p>COMEDY/DRAMA | UA | 1h 46m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=yU6zMPFd4UU'" value='VIEW TRAILER'>
        </td>
        </tr>
