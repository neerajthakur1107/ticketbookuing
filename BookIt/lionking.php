...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://whatwentwrongwith.files.wordpress.com/2019/07/wwww-the-lion-king-2019.jpg?w=1300">
    </div>
    <div class = "info">
      <h1>LION KING</h1>
      <p>FAMILY/ADVENTURE | 1h 58m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=7TavVZMewpY'" value='VIEW TRAILER'>
        </td>
        </tr>
