...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://www.arc.unsw.edu.au/generated/hero-large/artemis-fowl-1-jpeg.jpg?1593424949">
    </div>
    <div class = "info">
      <h1>ARTEMIS FOWL</h1>
      <p>FANTASY/SCI-FI | 1h 55m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=fl2r3Fwxz_o'" value='VIEW TRAILER'>
        </td>
        </tr>
