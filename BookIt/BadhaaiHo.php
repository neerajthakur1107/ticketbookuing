...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://resize.indiatvnews.com/en/resize/newbucket/1200_-/2019/08/badhaai-ho-759-1565588614.jpg">
    </div>
    <div class = "info">
      <h1>BADHAAI HO</h1>
      <p>Drama/COMEDY | UA | 2h 04m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
...
parent.location='https://www.youtube.com/watch?v=unAljCZMQYw'" value='VIEW TRAILER'>
        </td>
        </tr>
