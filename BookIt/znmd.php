...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://d2rdhxfof4qmbb.cloudfront.net/wp-content/uploads/20190123185617/ZMND-POSTER.jpg">
    </div>
    <div class = "info">
      <h1>ZINDAGI NA MILEGI DOBARA</h1>
      <p>Romance/Drama | U | 2h 35m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
...
parent.location='https://www.youtube.com/watch?v=FJrpcDgC3zU'" value='VIEW TRAILER'>
        </td>
        </tr>
