...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://globalsportmatters.com/wp-content/uploads/2018/09/Kabaddi.jpg
">
    </div>
    <div class = "info">
      <h1>KABADDI</h1>
    ...
    <div class= "trailer">
      ...
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=iamDm4nxIlY'" value='VIEW CLIP'>
        </td>
        </tr>
