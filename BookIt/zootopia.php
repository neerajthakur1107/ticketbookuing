...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://thedisinsider.com/wp-content/uploads/2021/03/scale-5.jpeg">
    </div>
    <div class = "info">
      <h1>ZOOTOPIA</h1>
      <p>FAMILY/COMEDY | 1h 50m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=jWM0ct-OLsM'" value='VIEW TRAILER'>
        </td>
        </tr>
