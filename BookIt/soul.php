...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://images.indianexpress.com/2020/12/soul-2.jpg">
    </div>
    <div class = "info">
      <h1>SOUL</h1>
      <p>FAMILY/COMEDY | 1h 47m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=xOsLIiBStEs'" value='VIEW TRAILER'>
        </td>
        </tr>
