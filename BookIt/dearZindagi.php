...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://i.ytimg.com/vi/EMqP7PFTjHU/maxresdefault.jpg">
    </div>
    <div class = "info">
      <h1>DEAR ZINDAGI</h1>
      <p>DRAMA/ROMANCE | UA | 2h 31m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=besOe0maHfw'" value='VIEW TRAILER'>
        </td>
        </tr>
