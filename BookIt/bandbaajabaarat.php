...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://i.ytimg.com/vi/9vfrOnbrbQE/maxresdefault.jpg">
    </div>
    <div class = "info">
      <h1>BAND BAAJA BAARAAT</h1>
      <p>Romance/Rom-Com | U | 2h 20m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
...
parent.location='https://www.youtube.com/watch?v=jz39LhmDNm8'" value='VIEW TRAILER'>
        </td>
        </tr>
