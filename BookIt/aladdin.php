...
<script src="https://kit.fontawesome.com/6236e2151f.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class = "image">
      <img src="https://i.ytimg.com/vi/o1Z8lfL90jk/maxresdefault.jpg">
    </div>
    <div class = "info">
      <h1>ALADDIN</h1>
      <p>FAMILY/MUSICAL | 2h 08m</p>
    </div>
    <div class= "trailer">
      <table class="buttons">
      <tr>
        <td>
      <input type=button class = "button button2" onClick="parent.location='https://www.youtube.com/watch?v=foyufD52aog'" value='VIEW TRAILER'>
        </td>
        </tr>
